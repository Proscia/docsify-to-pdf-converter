...
const prepareEnv = ({ pathToDocsifyEntryPoint, pathToStatic, pathToPublic }) => () => {
...
const cleanUp = ({ pathToDocsifyEntryPoint, pathToStatic, pathToPublic, removeTemp }) => async () => {
...
const closeProcess = ({ pathToDocsifyEntryPoint, pathToStatic, removeTemp }) => async code => {
  if (removeTemp) {
